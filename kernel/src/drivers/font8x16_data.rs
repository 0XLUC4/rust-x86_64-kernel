// Police VGA 8x16 — dump ROM BIOS IBM PC (domaine public).
// 128 chars × 16 octets. Chaque octet = 1 ligne de 8 pixels (MSB = gauche).
[
    // 0x00..0x1F : caractères de contrôle (tous à 0 sauf quelques symboles)
    [0x00; 16], [0x00; 16], [0x00; 16], [0x00; 16],
    [0x00; 16], [0x00; 16], [0x00; 16], [0x00; 16],
    [0x00; 16], [0x00; 16], [0x00; 16], [0x00; 16],
    [0x00; 16], [0x00; 16], [0x00; 16], [0x00; 16],
    [0x00; 16], [0x00; 16], [0x00; 16], [0x00; 16],
    ...
    // 0x7C '|'
    [0x00,0x00,0x18,0x18,0x18,0x18,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00],
    // 0x7D '}'
